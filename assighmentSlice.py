# -*- coding: utf-8 -*-
"""
Created on Mon Sep 19 19:27:47 2022
...
In array location (i,j), row i, column j,  
put the number i*j
...
print(f"row 2 of A, reverse order: {A[2,::-1]}")

print(f"sub matrix bottom right 2x2 {A[1:,5:]}")
